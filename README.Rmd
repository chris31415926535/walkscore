...
See also the package `walkscoreAPI` [available on CRAN](https://cran.r-project.org/web/packages/walkscoreAPI/index.html). Compared to `walkscoreAPI`, the current package `walkscore` has advantages for some use cases:
